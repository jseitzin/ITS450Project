...
<form action="add_specific_coffees.php" method="post" accept-charset="utf-8">
	...
	<fieldset><legend>Fill out the form to add one or more vehicles to the site.</legend>
		
		<div class="field"><label for="category"><strong>Manufacturers</strong></label><br />
		...
		$grinds = '<option value="FWD">FWD</option><option value="AWD">AWD</option><option value="RWD">RWD</option>';

		// Need the caffeinated/decaffeinated options:
		$caf_decaf = '<option value="Aventador">Aventador</option> <option value="Haracan">Haracan</option> <option value="Gallardo">Gallardo</option> <option value="Murcielago">Murciellago</option> <option value="458 Italia">458 Italia</option> <option value="599 GTO">599 GTO</option> <option value="488 GTB">488 GTB</option> <option value="Continental">Continental</option> <option value="Continental GT">Continental GT</option> <option value="Bentayga">Bentayga</option> <option value="Mulsanne">Mulsanne</option> <option value="Veyron">Veyron</option> <option value"Chiron">Chiron</option>';
